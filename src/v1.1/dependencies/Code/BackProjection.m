function pa_img = BackProjection(inputData, sensorsPositions, scanArray, sensorArray,xRange, yRange, zRange,samplingRate, speedOfSound, method )
...
% 1= coherence factor(CF) DAS,2- universal back projection(UBP),3=Minimum Variance(MV) BP, 4=MV & CF BP, 5=Directivity patern BP, ...
        ...
        for ii=1:Npixel_y
            for jj = 1:Npixel_x
                for kk = 1:Npixel_z
                    ...
                    cov_temp_all=(1/(Ns-L+1))*cov_temp_all;
